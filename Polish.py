...
def geomWrite(polish_file,mygeom,xform):
    Datastring=''
    firstpoint=0
    ...
    def export_files_as_polish(self,files_list,output_file):
        ...
        with io.open(output_file, 'w',1,None,None,'\r\n') as polish_file:
            ...
            for layer in layers_list:
                ...
                #idx will be -1 if no feild found
                for feature in iter:
                    ...
                    if MP_BIT_LVL_idx >=0:
                        ...
                        MP_BIT_LVL_val=24
                    if MP_NAME_idx>=0:
                        NAME_idx=layer.fieldNameIndex((attrs[MP_NAME_idx]))
                        if NAME_idx>=0:
                            NAME_val=(attrs[NAME_idx])
                        else:
                            NAME_val=''
                    else:
                        NAME_val=''
